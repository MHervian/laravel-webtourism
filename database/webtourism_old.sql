...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 08, 2023 at 07:27 AM
...
--
-- Table structure for table `paket_akomodasi`
--

CREATE TABLE `paket_akomodasi` (
  `id_paket_akomodasi` int(11) NOT NULL,
  `id_paket` int(11) NOT NULL,
  `id_akomodasi` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Table structure for table `paket_cat`
--

CREATE TABLE `paket_cat` (
  `id_paket_cat` int(11) NOT NULL,
  `nama` varchar(256) NOT NULL,
  `deskripsi` text DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Table structure for table `paket_dt`
--

CREATE TABLE `paket_dt` (
  `id_paket_dt` int(11) NOT NULL,
  `id_paket` int(11) NOT NULL,
  `id_dt` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Table structure for table `paket_kalender`
--

CREATE TABLE `paket_kalender` (
  `id_paket_kalender` int(11) NOT NULL,
  `id_paket` int(11) NOT NULL,
  `id_kalender` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Table structure for table `pesan_paket`
--

CREATE TABLE `pesan_paket` (
  `id_pesan_paket` int(11) NOT NULL,
  `id_paket` int(11) NOT NULL,
...
--
-- Indexes for table `paket_akomodasi`
--
ALTER TABLE `paket_akomodasi`
  ADD PRIMARY KEY (`id_paket_akomodasi`);

--
-- Indexes for table `paket_cat`
--
ALTER TABLE `paket_cat`
  ADD PRIMARY KEY (`id_paket_cat`);

--
-- Indexes for table `paket_dt`
--
ALTER TABLE `paket_dt`
  ADD PRIMARY KEY (`id_paket_dt`);

--
-- Indexes for table `paket_kalender`
--
ALTER TABLE `paket_kalender`
  ADD PRIMARY KEY (`id_paket_kalender`);
...
--
-- Indexes for table `pesan_paket`
--
ALTER TABLE `pesan_paket`
  ADD PRIMARY KEY (`id_pesan_paket`);
...
--
ALTER TABLE `akomodasi`
  MODIFY `id_akomodasi` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT for table `akomodasi_cat`
--
ALTER TABLE `akomodasi_cat`
  MODIFY `id_akomodasi_cat` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
-- AUTO_INCREMENT for table `paket_akomodasi`
--
ALTER TABLE `paket_akomodasi`
  MODIFY `id_paket_akomodasi` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `paket_cat`
--
ALTER TABLE `paket_cat`
  MODIFY `id_paket_cat` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `paket_dt`
--
ALTER TABLE `paket_dt`
  MODIFY `id_paket_dt` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `paket_kalender`
--
ALTER TABLE `paket_kalender`
  MODIFY `id_paket_kalender` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `pesan_paket`
--
ALTER TABLE `pesan_paket`
  MODIFY `id_pesan_paket` int(11) NOT NULL AUTO_INCREMENT;
