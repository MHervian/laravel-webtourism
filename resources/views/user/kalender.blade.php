...
<body>
    ...
    <div class="back-grey">
        <div class="container py-5 cs-acomodation">
                ...
                <form class="bg-light rounded-top p-4 shadow">
                    <div class="row">
                        ...
                        <div class="col-md-5 mb-md-0 mb-sm-3 mb-3 mb-lg-0">
                            <input type="text" class="form-control" placeholder="Input judul event...">
                        </div>
                        <div class="col-md-3">
            ...
            <div class="pb-4">
                <p style="font-weight: 700;">Kategori Kegiatan:</p>
                <ul class="nav-category p-0 m-0">
                    @foreach($kalender_cat as $kc)
                    <li class="bg-white border rounded mb-3"><a href="#" class="btn">{{ $kc->nama_cat }}</a></li>
                    @endforeach
                </ul>
            </div>
