                    ...
                    <form action="{{ $form_action }}" method="post" enctype="multipart/form-data">
                        <div class="card mb-4">
                            <div class="card-body">
                                @csrf
                                @if (isset($detail))
                                <input type="hidden" name="id_transportasi" value="{{ $detail->id_transportasi }}">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            <label for="nama" class="form-label">Nama Transportasi</label>
                                            <input type="text" id="nama" class="form-control" name="nama" value="{{ $detail->nama }}">
                                        </div>
                                        <div class="mb-3">
                                            <label for="deskripsi" class="form-label">Deskripsi</label>
                                            <textarea class="form-control" id="deskripsi" name="deskripsi">{{ $detail->deskripsi }}</textarea>
                                        </div>
                                        <div class="mb-3">
                                            <label for="gambar" class="form-label">Thumbnail</label>
                                            <input type="file" id="gambar" class="form-control" name="thumbnail">
                                        </div>
                                        <div class="mb-3">
                                            <label for="galeri" class="form-label">Input Galeri</label>
                                            <input type="file" id="galeri" class="form-control" name="galeri[]" multiple>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="mb-3">
