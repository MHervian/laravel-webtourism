            ...
            <main>
                <div class="container-fluid px-4">
                    ...
                    <ol class="breadcrumb mb-4">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('admin.agen') }}">Agen</a></li>
                    ...
                    <form action="{{ route($form_action) }}" method="post" enctype="multipart/form-data">
                        <div class="card mb-4">
                            <div class="card-body">
                                @csrf
                                @if (isset($detail))
                                <input type="hidden" name="id_agen_wisata" value="{{ $detail->id_agen_wisata }}">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="nokontak" id="nokontak" class="form-control" value="{{ $detail->no_kontak }}">
                                        </div>
                                        <div class="mb-3">
                                            <label for="thumbnail" class="form-label">Logo Agen</label>
                                            <input type="file" name="thumbnail" id="thumbnail" class="form-control" value="{{ $detail->thumbnail }}">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="mb-3">
