            ...
            <main>
                <div class="container-fluid px-4">
                    ...
                    <ol class="breadcrumb mb-4">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route($route_akomodasi) }}">Akomodasi</a></li>
                        <li class="breadcrumb-item active">{{ $detail->judul }}</li>
                    </ol>
                    <div class="card mb-4">
                        <div class="card-header">
                            Detail Informasi {{ $detail->judul }}
                            <a href="{{ route('admin.akomodasi.edit', ['id_akomodasi' => $detail->id_akomodasi]) }}" class="btn btn-primary btn-sm ms-2">
                                <i class="fas fa-edit"></i>
                                Edit
                            </a>
                            <a href="{{ route('admin.akomodasi.delete', ['id_akomodasi' => $detail->id_akomodasi]) }}" class="btn btn-danger btn-sm ms-2">
